...
<!--[if IE]>
        ...
        <![endif]-->
<title>Food Corner | All Orders</title>
										...
										<tr>
											...
											<td><a
												href="CustomerProductsOrderStatus?orderId=<%=resultOrders.getInt(2)%>"><button
														...
														onClick="return confirm('Are you sure want to change product delivery status?');">Pending</button></a></td>
											<%
												} else {
											%>
											<td><a
												href="CustomerProductsOrderStatus?orderId=<%=resultOrders.getInt(2)%>"><button
														...
														onClick="return confirm('Are you sure want to change product delivery status?');">Deliver</button></a></td>
											<%
												}
											%>
										</tr>
