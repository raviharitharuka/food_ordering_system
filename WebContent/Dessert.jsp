	...
	<div class="Dessert">
		<div class="container">
			...
			<div class="ele-bottom-grid">
				<h3>
					<span>You Can Order </span>Now
				</h3>
				<%
					ResultSet retriveProduct = DatabaseConnection
						.getResultFromSqlQuery("select * from tblproduct where product_category='Dessert'");
		...
		<div class="container">
			<ul>
				...
				<li><span class="glyphicon glyphicon-envelope"
					aria-hidden="true"></span><a href="mailto:info@example.com">service@foodcorner.com</a></li>
			</ul>
		</div>
	</div>
