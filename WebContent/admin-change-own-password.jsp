...
<!--[if IE]>
        ...
        <![endif]-->
<title>Food Corner | Change Password</title>
					...
					<div class="panel panel-info">
						...
						<div class="panel-body">
							<form role="form" action="AdminPasswordChange" method="post">
								...
								<input type="submit" class="btn btn-success" value="Update" onclick="return confirm('Are you sure want to change your password?');">
							</form>
						</div>
					</div>
				</div>
