 ...
 %>
	...
	<div class="contact">
		<div class="container">
			...
			<p>
			<h4>If you want any help please contact us!</h4>
			</p>
			<br>
			<div>
				<h4 class="section-subheading" align="left">
					<i class='fas fa-user'>&nbsp;&nbsp;Ravihari Gunawardhana</i>
				</h4>
			</div>
			<div>
				<h4 class="section-subheading" align="left">
					<i class='fas fa-envelope'>&nbsp;&nbsp;ravihari@gmail.com.</i>
				</h4>
			</div>
			<div>
				<h4 class="section-subheading" align="left">
					<i class='fas fa-phone'>&nbsp;&nbsp;0777123456</i>
				</h4>
			</div>
			<div>
				<h4 class="section-subheading" align="left">"Feel the life with food"</h4>
			</div>
		</div>
	</div>
	<!-- //contact -->
