...
<!--[if IE]>
        ...
        <![endif]-->
<title>Food Corner | Admin Dashboard</title>
		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-md-3 col-sm-3 col-xs-6">
					<div class="alert back-widget-set text-center" style="color:#272f49; border-color:#272f49;">
				...
				<div class="col-md-3 col-sm-3 col-xs-6">
					<div class="alert back-widget-set text-center" style="color:#191970; border-color:#191970;">
						...
						Total Orders
								...
								<div class="col-md-3 col-sm-3 col-xs-6">
					<div class="alert back-widget-set text-center" style="color:#420420; border-color:#420420;">
				...
				<div class="col-md-3 col-sm-3 col-xs-6">
					<div class="alert back-widget-set text-center" style="color:#8B0000; border-color:#8B0000;">
