...
<!--[if IE]>
        ...
        <![endif]-->
<title>Food Corner | Admin Panel</title>
			...
			<div class="col-md-12">
				<div class="navbar-collapse collapse ">
					<ul id="menu-top" class="nav navbar-nav navbar-right">
						...
						<li><a href="admin-login.jsp">Admin Panel</a></li>
					</ul>
				</div>
			</div>
		</div>
				...
				<div class="col-md-6 col-sm-6 col-xs-12">
					<div class="panel panel-danger">
						...
						<div class="panel-body">
							...
							%>
							<div class="alert alert-danger" id="danger">Incorrect email or password!</div>
							<%
								}
							%>
							<%
							...
							%>
							<div class="alert alert-info" id="info">You have entered
							...
							<form action="AdminLogin" method="post">
								...
								<div class="form-group" hidden>
									<label>Verification code : </label> <input type="text"
										...
										autocomplete="off" required style="height: 25px;" value="<%=captcha%>"/>&nbsp;<input
										type="text" name="captcha" value="<%=captcha%>" disabled
										style="height: 25px; width: 80px;">

								</div>
								<input type="submit" value="Login" class="btn btn-primary" style="float:right; width:150px">
