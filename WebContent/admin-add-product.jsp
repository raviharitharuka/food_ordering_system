	...
	<div class="content-wrapper">
		<div class="container">
			<div class="row pad-botm">
				<div class="col-md-12">
					<h4 class="header-line">Add Food Item</h4>
			...
			%>
			<div class="alert alert-danger" id="success">Food Item added successfully.</div>
			<%
				}
			%>
			<div class="row">
				<div class="col-md-12">
					<div class="panel panel-info">
						...
						<div class="panel-body">
							<form role="form" action="AddFood Items" method="post"
								...
								<div class="form-group">
									<label>Attach Food Item Image</label> <input type="file"
										name="uploadLogo" />
								</div>
								<button type="submit" class="btn btn-success" onclick="return confirm('Are you sure Do you want to add this Food Item?');">Add
									</button>
