...
<!--[if IE]>
        ...
        <![endif]-->
<title>Food Corner | Edit Food Items</title>
	...
	<div class="navbar navbar-inverse set-radius-zero">
		<div class="container">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="index-2.html"> <h2 style="color:#000080"><b>Food Corner</b><h2>
				</a>

			</div>

			<div class="right-div">
				<a href="admin-logout.jsp" class="btn btn-danger pull-right">Logout</a>
			</div>
		</div>
	</div>
	...
	<div class="content-wrapper">
		<div class="container">
			<div class="row pad-botm">
				<div class="col-md-12">
					<h4 class="header-line">Edit Food Items</h4>
				...
				<div class="col-md-12">
					<div class="panel panel-info">
						...
						<div class="panel-body">
							<form role="form" action="admin-edit-food-process.jsp"
								method="post">
								<div class="form-group" hidden>
									<label>Food Item Id</label> <input class="form-control"
										type="text" name="pid"
								...
								<a href="admin-view-food.jsp" class="btn btn-danger">Cancel</a>
							</form>
						</div>
						<%
							}
