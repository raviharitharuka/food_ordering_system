 ...
 %>
	...
	<div class="men-wear">
		<div class="container">
			<div class="container">
				<h2>
					<span><center>Place Order! Buy Now!</center></span>
				</h2>
			</div>
			<%
				ResultSet retriveProduct = DatabaseConnection
					.getResultFromSqlQuery("select * from tblproduct where product_category='Main meals'");
		...
		<div class="container">
			<ul>
				...
				<li><span class="glyphicon glyphicon-envelope"
					aria-hidden="true"></span><a href="mailto:info@example.com">ravihari@mail.com</a></li>
			</ul>
		</div>
	</div>
