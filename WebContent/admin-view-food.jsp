...
<!--[if IE]>
        ...
        <![endif]-->
<title>Food Corner | View Food Items</title>
	...
	<div class="content-wrapper">
		<div class="container-fluid">
			<div class="row pad-botm">
				<div class="col-md-12">
					<h4 class="header-line">View Food Items</h4>
				</div>
			</div>
			<div class="row">
								...
								<table class="table table-striped table-bordered table-hover">
									...
									<tbody>
										<tr>
											...
											<td><a
												href="admin-edit-food.jsp?id=<%=rs.getInt("id")%>"
												class="btn btn-primary">Edit</a>|<a
												href="admin-delete-food.jsp?id=<%=rs.getInt("id")%>"
												class="btn btn-danger" onclick="return confirm('Are you sure want to delete this product?');">Delete</a></td>
										</tr>
									</tbody>
									<%
										}
